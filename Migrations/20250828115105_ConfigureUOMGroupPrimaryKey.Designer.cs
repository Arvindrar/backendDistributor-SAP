...
namespace backendDistributor.Migrations
{
    ...
    [Migration("20250828115105_ConfigureUOMGroupPrimaryKey")]
    partial class ConfigureUOMGroupPrimaryKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backendDistributor.Models.ARInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("backendDistributor.Models.ARInvoiceAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ARInvoiceAttachments");
                });

            modelBuilder.Entity("backendDistributor.Models.ARInvoiceItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("backendDistributor.Models.ARInvoiceNumberTracker", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ARInvoiceNumberTrackers");
            ...
            modelBuilder.Entity("backendDistributor.Models.ARInvoiceAttachment", b =>
                {
                    b.HasOne("backendDistributor.Models.ARInvoice", "ARInvoice")
                        .WithMany("Attachments")
